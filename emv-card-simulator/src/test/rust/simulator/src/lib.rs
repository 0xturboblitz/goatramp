...
pub extern "system" fn Java_emvcardsimulator_SimulatorTest_entryPoint(
    ...
    unsafe {
        ...
        // So now all function calls on connection will be forwarded to the Java class
        ...
        // gets all applications using PSE (Payment System Environment)
        ...
        // selects the first application (AID) from the list
